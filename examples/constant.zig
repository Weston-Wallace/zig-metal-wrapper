...
const shader_source =
    ...
    \\
    \\kernel void multiply_values(device float* data [[buffer(0)]],
    \\                         constant float& scalar [[buffer(1)]],
    \\                         uint id [[thread_position_in_grid]])
    \\{
    \\    data[id] = data[id] * scalar;
    \\}
;
...
pub fn main() !void {
    ...
    var function = try library.getFunction("multiply_values", allocator);
    ...
    encoder.setBytes(scalar_bytes.ptr, scalar_bytes.len, 1);
